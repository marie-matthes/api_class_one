...
spreadsheet_id = "1kE1Sah_eEzTiv-Rz3WoW16oAzAfzTqHZRA66sPzhVUo"
...
people_options=["Marie", "Sathish", "Zahra", "Aycan","Andreas", "Jacky","Lukas", "Philipp", "Moritz", "Nikolay", "Haritha", "Mariia"]
